    ...
    return (
        <div className="container">
            <div className="row p-5 mt-5">
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="fs-5"><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h4>
                ...
                <div className="col-4 p-5 mt-1 mb-1">
                    <h4 className="fs-5"><i class="fa fa-credit-card" aria-hidden="true"></i> Funds</h4>
                ...
                <div className="col-4 p-5 mt-1 mb-1">
                    <h4 className="fs-5"><i class="fa fa-terminal" aria-hidden="true"></i> Console</h4>
                ...
                <div className="col-4 p-5 mt-1 mb-1">
                    <h4 className="fs-5"><i class="fa fa-circle-thin"></i> Coin</h4>
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Understanding mutul Funds</a><br/>
                   ...
                   <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}> Moving to Cion </a><br/>
